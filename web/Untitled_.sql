create database test_khoa_luan_9

go
use test_khoa_luan_9
...
CREATE TABLE [_search_feature] (
  [_id] varchar(255) PRIMARY KEY,
  [_id_feature] varchar(255),
  [_id_search_history] varchar(255),
  [_day_delete_table] datetime
)
GO

CREATE TABLE [_coment_feature] (
  [_id] varchar(255) PRIMARY KEY,
  [_id_feature] varchar(255),
  [_id_coment] varchar(255),
  [_day_delete_table] datetime
...
CREATE TABLE [_discount_feature] (
  [_id] varchar(255) PRIMARY KEY,
  [_id_feature] varchar(255),
  [_id_discount] varchar(255),
  [_day_delete_table] datetime
)
GO
...
ALTER TABLE [_feature] ADD FOREIGN KEY ([_id_manager_size_color]) REFERENCES [_manager_size_color] ([_id])
GO

ALTER TABLE [_feature] ADD FOREIGN KEY ([_id_user]) REFERENCES [_user] ([_id])
GO

ALTER TABLE [_search_feature] ADD FOREIGN KEY ([_id_feature]) REFERENCES [_feature] ([_id])
GO

ALTER TABLE [_search_feature] ADD FOREIGN KEY ([_id_search_history]) REFERENCES [_search_history] ([_id])
GO

ALTER TABLE [_coment_feature] ADD FOREIGN KEY ([_id_coment]) REFERENCES [_coment] ([_id])
GO

ALTER TABLE [_coment_feature] ADD FOREIGN KEY ([_id_feature]) REFERENCES [_feature] ([_id])
GO

ALTER TABLE [_discount_feature] ADD FOREIGN KEY ([_id_discount]) REFERENCES [_discount_product] ([_id])
GO

ALTER TABLE [_discount_feature] ADD FOREIGN KEY ([_id_feature]) REFERENCES [_feature] ([_id])
GO
...
INSERT INTO _manager_size_color (
  _id, _id_product, _id_size, _id_color, _sales, _day_delete_table
)
VALUES
('1', '1', '3', '15', 120, NULL),
('2', '1', '2', '8', 200, NULL),
