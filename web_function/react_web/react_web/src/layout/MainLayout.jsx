      ...
      <div className="main__navbar">
        <div className="main__navbar--item">
          <div className="item__logo">
            <img src="/img/b23d923ac45f6bdac43c9c4c329bd7da.gif" alt="" onClick={()=>{navigate("/")}} />
          </div>
        </div>
        <div className="main__navbar--item">
          <div className="item__pc">
              ...
              <div className="item__pc--link">
                {_check_token?(
                      <>
                        {_img_user!=0?(
                          <img src={"http://localhost:9004/user-service/api/v1/get_img/"+_img_user} alt="" />
                        ):(
                          <img src="/img/b23d923ac45f6bdac43c9c4c329bd7da.gif" alt="" onClick={()=>{navigate("/user-profile")}} />
                        )}
                        <p onClick={()=>{navigate("/user-profile")}}>{_name_user}</p>
                      </>
                ):(
                  <Button_1 value={"Login - Sigup"} _style2={{height:"30px",padding:"0px 20px"}} onclick_function={()=>{
                    navigate("/login-sigup")
                  }} ></Button_1>
                )}
              </div>
          </div>
