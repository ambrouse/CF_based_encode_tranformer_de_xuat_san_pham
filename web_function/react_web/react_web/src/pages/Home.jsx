        ...
        load_home_api().then(async (data)=>{
            if(data[1]){
                ...
                if(window.innerWidth>900){
                    ...
                    _set_not_recoment(Array.from({ length: (Math.floor(window.innerWidth/200))}, (_, i) => i))
                }else{
                    _set_not_recoment(Array.from({ length: (Math.floor(window.innerWidth/150))}, (_, i) => i))
                }
            }else{
                if(window.innerWidth>900){
                    _set_not_recoment(Array.from({ length: (Math.floor(window.innerWidth/300))}, (_, i) => i))
