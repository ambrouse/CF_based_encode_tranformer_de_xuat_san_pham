                            ...
                            <div className="main__title--item">
                                ...
                                onclick_function={()=>{
                                    add_card(_data_add_card).then((data)=>{
                                            if(data[1]){
                                                notification_active(true,"Da them vao gio hang")
                                            }else{
                                            ...
                                            {i._check_user?(<p onClick={()=>{
                                                delete_coment(i._id).then((data)=>{
                                                    if(data[1]){
                                                        ...
                                                        notification_active(true,"Da xoa coment")
                                                        animation()
                                                    }else{
                                                        notification_active(false,data[0])
                                                    }
                                        ...
                                        {i._coment?(
                                            <div className="content__more">
                                                <p onClick={()=>{
                                                    ...
                                                    console.log(index,box.classList.contains('content__textative'))
                                                }}>xem them</p>
                                            </div>
                                        ):""}
                                        {i._id_img_coments?(
                            ...
                            <div className="send__main--item">
                                ...
                                onClick={()=>{add_coment(_data_coment).then(async (data)=>{
                                    if(data[1]){
                                        ...
                                        notification_active(true,"Da dang coment")
                                        animation()
                                    }else{
                                        notification_active(false,data[0])
                                    }
